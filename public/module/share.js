...
let url = `https://www.facebook.com/sharer/sharer.php?u=https://modern-lab-alep.onrender.com/`;
  ...
  divsmall.addEventListener("click", () => {
    window.location.href = url;
  })
  divsmall3.addEventListener("click", () => {
    window.location.href = url;
  })
  ...
  share[0].addEventListener("click", () => {
    url = "https://www.facebook.com/sharer/sharer.php?u=https://modern-lab-alep.onrender.com/Analyser%20Sweden"
    product[0].appendChild(div);
  })
  share[1].addEventListener("click", () => {
    url = "https://www.facebook.com/sharer/sharer.php?u=https://modern-lab-alep.onrender.com/Analyser%20Germany"
    product[1].appendChild(div);
  })
  share[2].addEventListener("click", () => {
    url = "https://www.facebook.com/sharer/sharer.php?u=https://modern-lab-alep.onrender.com/Analyser%20chinese"
    product[2].appendChild(div);
  })
  share[3].addEventListener("click", () => {
    url = "https://www.facebook.com/sharer/sharer.php?u=https://modern-lab-alep.onrender.com/ميزان%20دقيق"
